...
public class TestJcoFunctionCalls {
    ...
    // Function 호출을 통한 Ping Test : 예시 STFC_CONNECTION 함수 < 공식 예시 >
    ...
    // Function 호출을 통한 Ping Test : 예시 RFC_SYSTEM_INFO 함수 < 공식 예시 >
    public void callWithStructure() throws JCoException
    {
        ...
        System.out.println("The same using field iterator: \nSystem info for "
                + jcoDestination.getAttributes().getSystemID() + ":\n");
    ...
    // Function 호출을 통한 Ping Test : 예시 BAPI_COMPANYCODE_GETLIST 함수 < 공식 예시 >
